...
#define kFlickrAPIKey @"39cb5a8150fdcfd145b791c66b9043ff"
...
+ (NSString *)flickrSearchURLForSearchTerm:(NSString *) searchTerm
{
    ...
    NSString * query = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&text=%@&per_page=20&format=json&nojsoncallback=1",kFlickrAPIKey,searchTerm];
    return query;
}
